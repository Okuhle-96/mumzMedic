...
function getSymptoms() {
    if ((chestPain.checked === true && shortBreath.checked === true) && age > 25) {
        diagnosis.innerHTML = username + ", it lools like you have a Heart Diseases. Please proceed to locate the nearest Doctors."
        setTimeout(function() {
            diagnosis.innerHTML = "";
        }, 8000)
    } if (nausea.checked === true && cramps.checked === true) {
        diagnosis.innerHTML = "Congratulations, you just mightbr pregnant." + username + ". Please wait as I connect you with the nearest Gynaecologist."
        setTimeout(function() {
            diagnosis.innerHTML = "";
        }, 8000)
    }
